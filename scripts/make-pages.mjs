...
const PAGES = [
  ...
  // Audio and video. One component, ffmpeg in the browser, engine loaded
  // from a CDN the first time anything runs.
  { slug: 'mp4-to-mp3', component: 'MediaConvert', props: 'to="mp3" source="video"',
    sub: 'Keep the sound, drop the picture.' },
  { slug: 'mp4-to-wav', component: 'MediaConvert', props: 'to="wav" source="video"',
    sub: 'Uncompressed audio out of a video.' },
  { slug: 'webm-to-mp3', component: 'MediaConvert', props: 'to="mp3" source="video"',
    sub: 'Pull the audio out of a WebM.' },
  { slug: 'video-to-mp3', component: 'MediaConvert', props: 'to="mp3" source="video"',
    sub: 'Any video in, an MP3 out.' },
  { slug: 'convert-to-audio', component: 'MediaConvert', props: 'to="mp3" source="both"',
    sub: 'Anything with sound in it, turned into an MP3.' },
  { slug: 'mp3-to-wav', component: 'MediaConvert', props: 'to="wav" source="audio"',
    sub: 'For editing, where uncompressed is wanted.' },
  { slug: 'mp3-to-ogg', component: 'MediaConvert', props: 'to="ogg" source="audio"',
    sub: 'Smaller at the same quality, and patent free.' },
  { slug: 'mp3-to-m4a', component: 'MediaConvert', props: 'to="m4a" source="audio"',
    sub: 'The format Apple devices prefer.' },
  { slug: 'wav-to-mp3', component: 'MediaConvert', props: 'to="mp3" source="audio"',
    sub: 'Shrink a recording down to something sendable.' },
  { slug: 'wav-to-ogg', component: 'MediaConvert', props: 'to="ogg" source="audio"',
    sub: 'Compressed, open, and small.' },
  { slug: 'wav-to-m4a', component: 'MediaConvert', props: 'to="m4a" source="audio"',
    sub: 'Compressed for Apple devices.' },
  { slug: 'm4a-to-mp3', component: 'MediaConvert', props: 'to="mp3" source="audio"',
    sub: 'For anything that will not play M4A.' },
  { slug: 'm4a-to-wav', component: 'MediaConvert', props: 'to="wav" source="audio"',
    sub: 'Uncompressed, for editing.' },
  { slug: 'ogg-to-mp3', component: 'MediaConvert', props: 'to="mp3" source="audio"',
    sub: 'For players that never learned Ogg.' },
  { slug: 'ogg-to-wav', component: 'MediaConvert', props: 'to="wav" source="audio"',
    sub: 'Uncompressed, for editing.' },
  { slug: 'mp4-to-webm', component: 'MediaConvert', props: 'to="webm" source="video"',
    sub: 'Smaller, and what the web prefers.' },
  { slug: 'mov-to-mp4', component: 'MediaConvert', props: 'to="mp4" source="video"',
    sub: 'The iPhone recording that will not play on Windows.' },
  { slug: 'mov-to-webm', component: 'MediaConvert', props: 'to="webm" source="video"',
    sub: 'From an iPhone recording straight to the web.' },
  { slug: 'webm-to-mp4', component: 'MediaConvert', props: 'to="mp4" source="video"',
    sub: 'For anything that will not play WebM.' },
  { slug: 'gifv-to-mp4', component: 'MediaConvert', props: 'to="mp4" source="video"',
    sub: 'A looping clip as an ordinary video.' },
  { slug: 'gifv-to-webm', component: 'MediaConvert', props: 'to="webm" source="video"',
    sub: 'A looping clip, smaller.' },
  { slug: 'mp4-to-gifv', component: 'MediaConvert', props: 'to="mp4" source="video"',
    sub: 'A short silent loop, far smaller than a GIF.' },
  { slug: 'mov-to-gifv', component: 'MediaConvert', props: 'to="mp4" source="video"',
    sub: 'A short silent loop from an iPhone clip.' },
  { slug: 'webm-to-gifv', component: 'MediaConvert', props: 'to="mp4" source="video"',
    sub: 'A short silent loop from a WebM.' },
  { slug: 'convert-to-video', component: 'MediaConvert', props: 'to="mp4" source="both"',
    sub: 'Anything in, an MP4 out.' },
  { slug: 'mp4-to-gif', component: 'MediaConvert', props: 'to="gif" source="video"',
    sub: 'Pick the width and frame rate, and watch the size.' },
  { slug: 'audio-trimmer', component: 'MediaConvert', props: 'to="mp3" mode="trim" source="audio"',
    sub: 'Cut the start and the end off a recording.' },
  { slug: 'video-compressor', component: 'MediaConvert', props: 'to="mp4" mode="compress" source="video"',
    sub: 'For the clip too big to send.' },
  { slug: 'compress-video', component: 'MediaConvert', props: 'to="mp4" mode="compress" source="video"',
    sub: 'Make a video smaller without a desktop editor.' },
];
