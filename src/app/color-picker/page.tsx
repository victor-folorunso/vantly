...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `${SITE.url}/color-picker` },
  openGraph: { title: tool.title, description: tool.description, url: `${SITE.url}/color-picker` },
};
